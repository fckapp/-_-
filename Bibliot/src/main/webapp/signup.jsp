    ...
    <head>
        ...
        function sendVerificationEmail() {
	        ...
	        $.ajax({
	            ...
	            type: "post",
	            dataType: "json",
	            data: { "email": email },  // email 변수를 바로 사용
        ...
        function sendEmailVerification() {
            ...
            location.href = '<%= request.getContextPath() %>/sendEmailVerification?email=' + email;
        }

        function verifyCode() {
        	const verificationCode = document.getElementById("verificationCode").value;
            location.href = '<%= request.getContextPath() %>/verifyCode?verificationCode=' + verificationCode;
        }
    	</script>
    </head>
