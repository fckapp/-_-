        ...
        <div class="menu-pan-box">
            <div class="menu-category">
                ...
                <div class="main-product-text-box">
                    ...
                    <a href="<%= request.getContextPath() %>/evBatteryPage.jsp" class="main-product-text-1">상세보기</a>
            ...
            <div class="menu-category">
                ...
                <div class="main-product-text-box">
                    ...
                    <a href="<%=request.getContextPath()%>/EVBattery" class="main-product-text-1">상세보기</a>
                    <a href="<%=request.getContextPath()%>/Inquery" class="main-product-text-2">문의하기</a>
                </div>
            </div>
            <div class="menu-category">
                ...
                <div class="main-product-text-box">
                    ...
                    <a href="<%=request.getContextPath()%>/SolarBattery" class="main-product-text-1">상세보기</a>
                    <a href="<%=request.getContextPath()%>/Inquery" class="main-product-text-2">문의하기</a>
                </div>
            </div>
            <div class="menu-category">
