        ...
        <div class="introduction-wrapper">
            ...
            <div class="introduction-second-content">
                ...
                <div class="introductionPage-to-detailsPage-btn-box">
                    <button class="introductionPage-to-detailsPage-btn" type="button" onclick="location.href='<%=request.getContextPath()%>/EVBattery'">제품 상세보기</button>
                </div>
            ...
            <div class="introduction-fourth-content">
                ...
                <div class="introduction-right">
                    ...
                    <button type="button" class="go-to-hire-btn" aria-label="채용공고 버튼" onclick="location.href='<%=request.getContextPath()%>/recruitment'">채용정보 보기</button>
                </div>
            </div>
        </div>
    </tbody>
